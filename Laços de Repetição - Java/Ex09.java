...
public class Ex09 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A média de altura entre 10 e 20 anos é de: " + (contadorAltura / contador10_20) + "cm");
        System.out.printf("A porcentagem de pessoa inferior a 40 quilos foi de: %s ", (contadorPeso * 100) / (contador), "%");
    }
}